...
if( isAddForm()) {
  ...
  const end=".png";
   ...
   const errorMsg: string = "L' url n'est pas valable.";
  ...
  if(!/^[a-zA-Zàéè ]{3,25}$/.test(form.name.value)){
    ...
    const errorMsg: string ='le nom du prenom est requis(1-25).';
    const newField: Field={value: form.name.value, error: errorMsg, isValid: false};
    newForm={...newForm, ...{nname: newField}};
  ...
  if(!/^[0-9]{1,3}$/.test(form.hp.value)){
    const errorMsg: string ='les points de vie de pokémon sont compris entre 0 et 999.';
  ...
  if(!/^[0-9]{1,2}$/.test(form.cp.value)){
    const errorMsg: string ='les degats de pokemons sont compris 0 et 99.';
              ...
              <div className="card-content">
                ...
                <div className="form-group">
                  ...
                  <input id="picture" type="text" name="picture" className="form-control" value={form.picture.value} onChange={e=>handleInputChange(e)}></input>
                    ...
                    { form.picture.error &&
                  <div className="card-panel red acccent-1">
                    {form.picture.error}
                    </div>  }
...
{/* Pokemon  name*/}
                ...
                <div className="form-group">
                  ...
                  <input id="picture" type="text" name="picture" className="form-control" value={form.name.value} onChange={e=>handleInputChange(e)}></input>
